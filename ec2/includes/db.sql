CREATE DATABASE IF NOT EXISTS new_ec_20240126;
USE new_ec_20240126;
...
CREATE TABLE products (
    ...
    products_stock TINYINT NOT NULL DEFAULT 1,
    products_pic_path VARCHAR(255) NOT NULL DEFAULT 'web-projects/ec2/imgs/default.webp',
...
/opt/lampp/htdocs/web-projects/ec2/imgs
web-projects/ec2/imgs